...
export class UEReadHelper {
  ...
  peekInt8() {
    return this.rdr.getInt8(this.pos, true);
  }
  peekUint8() {
    return this.rdr.getUint8(this.pos, true);
  }
  peekInt16() {
    return this.rdr.getInt16(this.pos, true);
  }
  peekUint16() {
    return this.rdr.getUint16(this.pos, true);
  }
  peekInt32() {
    return this.rdr.getInt32(this.pos, true);
  }
  peekUint32() {
    return this.rdr.getUint32(this.pos, true);
  }
  peekFloat32() {
    return this.rdr.getFloat32(this.pos, true);
  }
  peekFloat64() {
    return this.rdr.getFloat64(this.pos, true);
  }
  peekInt64() {
    return Number(this.rdr.getBigInt64(this.pos, true));
  }
  peekUint64() {
    return Number(this.rdr.getBigUint64(this.pos, true));
  }
  peekString() {
    return this.src.substring(this.pos + 4, this.pos + this.peekInt32() + 3);
  }
  peekString64() {
    return this.src.substring(this.pos + 8, this.pos + this.peekInt64() + 7);
  }
  peekStringCustom(cnt) {
    return this.src.substring(this.pos + 4, this.pos + cnt + 3);
  }
  peekString64Custom(cnt) {
    return this.src.substring(this.pos + 8, this.pos + cnt + 7);
  }
  peekGuid() {
    let tpos = this.pos;
  ...
  getUint8() {
    let z = this.peekUint8();
    this.pos += 1;
    return z;
  }
  getInt16() {
    let z = this.peekInt16();
    this.pos += 2;
    return z;
  }
  getUint16() {
    let z = this.peekUint16();
    this.pos += 2;
    return z;
  }
  getInt32() {
    let z = this.peekInt32();
    this.pos += 4;
    return z;
  }
  getUint32() {
    let z = this.peekUint32();
    this.pos += 4;
    return z;
  }
  getFloat32() {
    let z = this.peekFloat32();
    this.pos += 4;
    return z;
  }
  getFloat64() {
    let z = this.peekFloat64();
    this.pos += 8;
    return z;
  }
  getInt64() {
    let z = this.peekInt64();
    this.pos += 8;
    return z;
  }
  getUint64() {
    let z = this.peekUint64();
    this.pos += 8;
    return z;
  }
  getString() {
    let z = this.peekString();
    this.pos += this.peekInt32() + 4;
    return z;
  }
  getString64() {
    let z = this.peekString64();
    this.pos += this.peekInt64() + 8;
    return z;
  }
  getStringCustom(cnt) {
    let z = this.peekStringCustom(cnt);
    this.pos += cnt + 4;
    return z;
  }
  getString64Custom(cnt) {
    let z = this.peekString64Custom(cnt);
    this.pos += cnt + 8;
    return z;
  }
  getGuid() {
