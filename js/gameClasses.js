...
const gameClasses = {
    ...
    'Pipesystem_C'                            : new GameClass('Pipesystem',                       'pipe',                     null,       'pipesys',           'pipesys'),
    'PipesystemNew_C'                         : new GameClass('Pipesystem',                       'pipe',                     null,       'pipesys',           'pipesys'),
    'PipesystemNewDLC_C'                      : new GameClass('Pipesystem',                       'pipe',                     null,       'pipesys',           'pipesys'),
