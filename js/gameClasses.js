...
const gameClasses = {
    ...
    'BP_DoubleHealthLoot_C'                   : new GameClass('Double Health Drops',              'health',                   'upgrades', 'shop'),
    ...
    'BuyEnemiesLoot_C'                        : new GameClass('Health Bars',                      'see_health_bar',           'upgrades', 'shop'),
    ...
    'BuyGunAlt_C'                             : new GameClass('Gun 2nd Fire',                     'gun_red_wood',             'upgrades', 'shop'),
    'BuyGunCoin_C'                            : new GameClass('Gun Collects Coins',               'gun_upgrade',              'upgrades', 'shop'),
    ...
    'BuyGunHoly1_C'                           : new GameClass('Holy Gun Wooden Crosses',          'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunHoly2_C'                           : new GameClass('Holy Gun Stone Graves',            'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunRefillSpeed+66_C'                  : new GameClass('Gun Refill Speed +66',             'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunRefireRate50_C'                    : new GameClass('Gun Cooldown',                     'gun_upgrade',              'upgrades', 'shop'),
    ...
    'BuySwordHoly1_C'                         : new GameClass('Holy Sword Wooden Crosses',        'sword_holy',               'upgrades', 'shop'),
    ...
    'BuyUpgradeChestNum_C'                    : new GameClass('See Chest Count',                  'see_chest_count',          'upgrades', 'shop'),
    ...
    'Jumppad_C_Puzzle'                        : new GameClass('Jumppad',                          'jumppad:v',                'extra', null,              'extra'),
    ...
    'Pipesystem_C'                            : new GameClass('Pipe',                             'pipe',                     'pipesys',       null,           'pipesys'),
    'Pipesystem_C_Puzzle'                     : new GameClass('Pipe',                             'pipe',                     'extra',       null,             'extra'),
    'PipesystemNew_C'                         : new GameClass('Pipe',                             'pipe',                     'pipesys',       null,           'pipesys'),
    'PipesystemNewDLC_C'                      : new GameClass('Pipe',                             'pipe',                     'pipesys',       null,           'pipesys'),
    ...
    'BP_RebuildSlum_C'                        : new GameClass('Rebuild Slum Quest',               'pickaxe_cooldown',         'upgrades', 'shop'),
}
