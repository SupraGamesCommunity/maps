...
const gameClasses = {
    ...
    'BuySword2_C'                             : new GameClass('Red Sword',                        'sword_red',                'upgrades', 'collectable'),
    ...
    'BuySword_C'                              : new GameClass('Sword',                            'sword',                    'upgrades', 'collectable'),
    ...
    'SL1:BuyTranslocator_C'                   : new GameClass('Translocator',                     'translocator',             'upgrades', 'collectable'),
    ...
    'Waldo:RedGuy_C'                          : new GameClass('Waldo',                            'waldo:v',                  'misc', 'collectable', 'misc'),
