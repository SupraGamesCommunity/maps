...
const gameClasses = {
    ...
    'Pipesystem_C'                            : new GameClass('Pipesystem',                       'pipe',                     'pipesys',       null,           'pipesys'),
    'PipesystemNew_C'                         : new GameClass('Pipesystem',                       'pipe',                     'pipesys',       null,           'pipesys'),
    'PipesystemNewDLC_C'                      : new GameClass('Pipesystem',                       'pipe',                     'pipesys',       null,           'pipesys'),
