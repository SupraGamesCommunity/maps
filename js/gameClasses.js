...
const gameClasses = {
    ...
    'BP_BuyBeamElasticity_C'                  : new GameClass('Beam Elasticity',                  null,                       'upgrades', 'shop'),
    'BP_BuyBoomerAxe_C'                       : new GameClass('Boomeraxe',                        null,                       'upgrades', 'shop'),
    ...
    'BP_BuyGunDuration+2s_C'                  : new GameClass('Gun Duration +2s',                 'gun_upgrade',              'upgrades', 'shop'),
    'BP_BuyGunRechargeTime-50pct_C'           : new GameClass('Gun Recharge Time -50%',           'gun_upgrade',              'upgrades', 'shop'),
    ...
    'BP_PickaxeDamage+1_C'                    : new GameClass('Pickaxe Damage +1',                'gun_upgrade',              'upgrades', 'shop'),
    'BP_PurchaseHealth+1_C'                   : new GameClass('Health +1',                        'health',                   'upgrades', 'shop'),
    'BP_PurchaseJumpHeightPlus_C'             : new GameClass('Jump Height +',                    'double_jump',              'upgrades', 'shop'),
    'BP_PurchaseSpeedx2_C'                    : new GameClass('Speed x2',                         'speed',                    'upgrades', 'shop'),
    'BP_Purchase_Crouch_C'                    : new GameClass('Crouch',                           null,                       'upgrades', 'shop'),
    'BP_Purchase_FasterPickaxe_C'             : new GameClass('Faster Pickaxe',                   'boomeraxe_range',          'upgrades', 'shop'),
    ...
    'BP_TrophyDetector_C'                     : new GameClass('Trophy Detector',                  null,                       'upgrades', 'shop'),
    ...
    'BuyChestDetectorRadius_C'                : new GameClass('Chest Detector Radius',            null,                       'upgrades', 'shop'),
    'BuyChestDetector_C'                      : new GameClass('Chest Detector',                   'see_chest_count',          'upgrades', 'shop'),
    'BuyCoinMagnet_C'                         : new GameClass('Coin Magnet',                      null,                       'upgrades', 'shop'),
    'BuyCritChance+5_C'                       : new GameClass('Crit Chance +5',                   'gun_upgrade',              'upgrades', 'shop'),
    ...
    'BuyEnemiesLoot_C'                        : new GameClass('Enemies Loot',                     null,                       'upgrades', 'shop'),
    ...
    'BuyForceBeam_C'                          : new GameClass('Force Beam',                       'force_beam_upgrade',       'upgrades', 'shop'),
    ...
    'BuyForceCubeStompGrave3_C'               : new GameClass('Force Cube Stomp Grave',           'stomp_damage',             'upgrades', 'shop'),
    ...
    'BuyGraveDetector_C'                      : new GameClass('Grave Detector',                   null,                       'upgrades', 'shop'),
    'BuyGun1_C'                               : new GameClass('Red Macguffin',                    'gun_red',                  'upgrades', 'shop'),
    'BuyGunAltDamagex2_C'                     : new GameClass('Gun Alt Damagex2',                 'gun_damage',               'upgrades', 'shop'),
    'BuyGunAlt_C'                             : new GameClass('Gun Alt',                          'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunCoin_C'                            : new GameClass('Gun Coin',                         'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunComboDamage+25_C'                  : new GameClass('Gun Combo Damage +25',             'gun_damage',               'upgrades', 'shop'),
    'BuyGunCriticalDamageChance_C'            : new GameClass('Gun Critical Damage Chance',       'gun_damage',               'upgrades', 'shop'),
    'BuyGunCriticalDamage_C'                  : new GameClass('Gun Critical Damage',              'gun_damage',               'upgrades', 'shop'),
    'BuyGunDamage+15_C'                       : new GameClass('Gun Damage +15',                   'gun_damage',               'upgrades', 'shop'),
    'BuyGunDamage+1_C'                        : new GameClass('Gun Damage +1',                    'gun_damage',               'upgrades', 'shop'),
    'BuyGunDamage+5_C'                        : new GameClass('Gun Damage +5',                    'gun_damage',               'upgrades', 'shop'),
    ...
    'BuyGunSplashDamage_C'                    : new GameClass('Gun Splash Damage',                'gun_damage',               'upgrades', 'shop'),
    ...
    'BuyHeartLuck_C'                          : new GameClass('Heart Luck',                       'health',                   'upgrades', 'shop'),
    'BuyJumpHeightPlus_C'                     : new GameClass('Jump Height +',                    null,                       'upgrades', 'shop'),
    'BuyJumpIncrease_C'                       : new GameClass('Jump Increase',                    'double_jump',              'upgrades', 'shop'),
    'BuyMoreLoot_C'                           : new GameClass('More Loot',                        null,                       'upgrades', 'shop'),
    'BuyNumberRising_C'                       : new GameClass('Number Rising',                    null,                       'upgrades', 'shop'),
    ...
    'BuyShowHealthbar_C'                      : new GameClass('Show Healthbar',                   'see_enemy_health',         'upgrades', 'shop'),
    'BuyShowProgress_C'                       : new GameClass('Show Progress',                    null,                       'upgrades', 'shop'),
    ...
    'BuySmashdown_C'                          : new GameClass('Stomp',                            'stomp_damage',             'upgrades', 'shop'),
    'BuySpeedx15_C'                           : new GameClass('Speed x15',                        'speed',                    'upgrades', 'shop'),
    'BuySpeedx2_C'                            : new GameClass('Speed x2',                         'speed',                    'upgrades', 'shop'),
    'BuyStats_C'                              : new GameClass('Stats',                            'awesome',                  'upgrades', 'shop'),
    'BuySword2_C'                             : new GameClass('Red Sword',                        'sword',                    'upgrades', 'shop'),
    'BuySwordCriticalDamageChance_C'          : new GameClass('Sword Critical Damage Chance',     'sword_critical',           'upgrades', 'shop'),
    'BuySwordCriticalDamage_C'                : new GameClass('Sword Critical Damage',            'sword_critical',           'upgrades', 'shop'),
    ...
    'BuySwordRange25_C'                       : new GameClass('Sword Range 25',                   null,                       'upgrades', 'shop'),
    'BuySwordRefireRate-33_C'                 : new GameClass('Sword Refire Rate -33',            null,                       'upgrades', 'shop'),
    ...
    'BuyTranslocatorModule_C'                 : new GameClass('Translocator Module',              null,                       'upgrades', 'shop'),
    'BuyTranslocatorShotForce_C'              : new GameClass('Translocator Shot Force',          'translocator_distance',    'upgrades', 'shop'),
    'BuyTranslocatorWeight_C'                 : new GameClass('Translocator Weight',              null,                       'upgrades', 'shop'),
    ...
    'BuyUpgradeChestNum_C'                    : new GameClass('Upgrade Chest Num',                null,                       'upgrades', 'shop'),
    'BuyUpgradeGraveNum_C'                    : new GameClass('Upgrade Grave Num',                null,                       'upgrades', 'shop'),
    'BuyWalletx15_C'                          : new GameClass('Wallet x15',                       null,                       'upgrades', 'shop'),
    'BuyWalletx2_C'                           : new GameClass('Wallet x2',                        null,                       'upgrades', 'shop'),
    ...
    'Jumppad_C'                               : new GameClass('Jumppad',                          'jumppad',                  null,       null,           'jumppads'),
    ...
    'SecretFound_C'                           : new GameClass('Secret Found',                     'secret:24',                'misc'),
    'SnappyPipe'                              : new GameClass('Snappy Pipe',                      'pipe',                     'extra'),
    'CarryPipe_C'                             : new GameClass('Carry Pipe',                       'pipe',                     'extra'),
    'PipeCap_C'                               : new GameClass('Pipe Cap',                         'pipe_cap',                 'extra'),
