...
/* exported GameClass */
class GameClass {
    constructor(type, icon, layer, nospoiler) {
        this.type = type                // One of the class type names (from the game)
...
const gameClasses = {
    ...
    "BP_EngagementCup_Base_C"           : new GameClass("trophy",                   "collectable", "misc"),
    "BP_MonsterChest_C"                 : new GameClass("chest",                    "chests",      ""),
    ...
    "BarrelColor_C"                     : new GameClass("barrel_gold",              "collectable", "misc"),
    "BarrelRed_C"                       : new GameClass("barrel_red",               "collectable", "misc"),
    "BarrelClosed_Blueprint_C"          : new GameClass("barrel_gold",              "collectable", "misc"),
    "Battery_C"                         : new GameClass(null,                       "extra",       ""),
    "Bones_C"                           : new GameClass("bones",                    "collectable", "misc"),
    ...
    "BuyCrystal_C"                      : new GameClass("moon_red",                 "collectable", "misc"),
    ...
    "DeadHero_C"                        : new GameClass("hero_placeholder",         "collectable", "misc"),
    ...
    "Jumppad_C"                         : new GameClass("map",                      "jumppads",    ""),
    ...
    "MoonTake_C"                        : new GameClass("moon_green",               "collectable", "misc"),
    ...
    "Scrap_C"                           : new GameClass("scrap",                    "collectable", "misc"),
    ...
    "ValveCarriable_C"                  : new GameClass("valve",                    "collectable", "misc"),
    ...
    "PipeCap_C"                         : new GameClass("pipe_red",                 "pipesys",     ""),
    "PipesystemNew_C"                   : new GameClass("pipe_green",               "pipesys",     ""),
