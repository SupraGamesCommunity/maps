...
const gameClasses = {
    ...
    'EX:BarrelColor_C'                        : new GameClass('Gold Barrel',                      'barrel_gold',              'extra',    'extra'),
    'BarrelRed_C'                             : new GameClass('Red Barrel',                       'barrel_red',               'misc',     'collectable'),
    'EX:BarrelRed_C'                          : new GameClass('Red Barrel',                       'barrel_red',               'extra',    'extra'),
    ...
    'CrashEnemySpawner_C'                     : new GameClass('Skeleton',                         'bones_monster',            'misc',     'collectable'),
    ...
    'BuyCritChance+5_C'                       : new GameClass('Critical Chance +5%',              'sword_damage',            'upgrades', 'shop'),
    ...
    'BuyGunAltDamagex2_C'                     : new GameClass('Gun Altfire Damage x2',            'gun_upgrade',              'upgrades', 'shop'),
    'BuyGunAlt_C'                             : new GameClass('2nd Fire',                         'gun_red',                  'upgrades', 'shop'),
    ...
    'BuyGunCriticalDamageChance_C'            : new GameClass('Gun Fire Critical Damage Chance +5%','gun_upgrade',            'upgrades', 'shop'),
    ...
    'BuyHealthRegenMax5_C'                    : new GameClass('Regeneration Ceiling +5',          'health_regen_max',         'upgrades', 'shop'),
    ...
    'Jumppad_C'                               : new GameClass('Jumppad',                          'jumppad:v',                'extra',    null,           'extra'),
    'FT:Jumppad_C'                            : new GameClass('Jumppad',                          'jumppad:v',                'jumppads', null,           'jumppads'),
    ...
    'Purchase_WoodPickaxe_C'                  : new GameClass('Wooden Pickaxe',                   'pickaxe_wood',             'upgrades', 'shop'),
    ...
    'Juicer_C'                                : new GameClass('Juicer',                           'bucket:v',                 'upgrades', 'collectable'),
    ...
    'Pipesystem_C'                            : new GameClass('Pipe',                             'pipe',                     'extra',    null,           'extra'),
    'FT:Pipesystem_C'                         : new GameClass('Pipe',                             'pipe',                     'pipesys',  null,           'pipesys'),
    'PipesystemNew_C'                         : new GameClass('Pipe',                             'pipe',                     'extra',    null,           'extra'),
    'PipesystemNewDLC_C'                      : new GameClass('Pipe',                             'pipe',                     'extra',    null,           'extra'),
